...
The outline spends nothing. It is paint outside the border box — no layout, no hit testing, no contrast — and moving it is the one change available that costs the control none of its own properties.
