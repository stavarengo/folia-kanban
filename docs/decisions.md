...
**Decided 2026-09-21. Eight things keep a colour of Folia's own, because the host variable would erase a distinction the board is making on purpose, or because taking it would be a change nobody here can check.**
