...
- **Search & quick filters** — press `/` to search by title, file name, tag, priority or assignee, or by token (`due:`, `priority:`, `assignee:`, `is:blocked`, `unread:comments`, …); one-click **Mine** / **Overdue** / **Due soon** / **Blocked** / **Unread** filters.
